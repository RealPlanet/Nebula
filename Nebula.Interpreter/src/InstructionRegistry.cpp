...
#define CHECK_GC_OBJECT_VALID(obj) { if(obj == nullptr) return InstructionErrorCode::UndefinedObject;  }
#define CHECK_GC_OBJECT_IS_BUNDLE(obj) { CHECK_GC_OBJECT_VALID(obj) if(obj->GetType() != ObjectType::Bundle) return InstructionErrorCode::NotABundle;  }
#define CHECK_GC_OBJECT_IS_ARRAY(obj) { CHECK_GC_OBJECT_VALID(obj) if(obj->GetType() != ObjectType::Array) return InstructionErrorCode::NotAnArray;  }
