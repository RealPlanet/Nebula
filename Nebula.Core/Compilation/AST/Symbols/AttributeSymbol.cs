...
namespace Nebula.Core.Compilation.AST.Symbols
{
        ...
        : Symbol
    {
        ...
        private static readonly Dictionary<string, AttributeSymbol> _symbols = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { AttributeType.AutoGenerated.ToString(), new(AttributeType.AutoGenerated.ToString(), true, false)},
            { AttributeType.Initializer.ToString(), new(AttributeType.Initializer.ToString(), true, false)},
        };
        ...
        public static AttributeSymbol FromEnum(AttributeType type)
        {
            return FromName(type.ToString());
        }
    }
}
