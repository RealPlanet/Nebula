    ...
    public sealed class Binder
    {
        ...
        private void CreateStaticInitializer()
        {
            ...
            if (_currentUnit.Globals.Count > 0)
            {
                ...
                FunctionSymbol funcSymbol = new("0__script_static_ctor__0",
                                                [],
                ...
                if (funcSymbol.Name != null && !_currentScope.TryDeclareFunction(funcSymbol))
                {
                ...
                foreach (var kvp in _currentProgram.Globals)
                {
                    ...
                    var statement = new AbstractExpressionStatement(variable.OriginalNode,
                                                                    AbstractNodeFactory.Assignment(variable.OriginalNode, variable.Variable, variable.Initializer));
