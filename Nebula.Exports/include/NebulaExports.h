...
extern "C"
{
    ...
    __declspec(dllexport) nebula::Value* Frame_GetLocalVariableAt(nebula::Frame* handle, int index);
    __declspec(dllexport) nebula::Value* Frame_GetParameterVariableAt(nebula::Frame* handle, int index);
    ...
    // Variable
    __declspec(dllexport) int FrameVariable_GetType(nebula::Value* handle);
    __declspec(dllexport) const char* FrameVariable_GetStringValue(nebula::Value* handle);
    __declspec(dllexport) bool FrameVariable_SetStringValue(nebula::Value* handle, const char* value);
    __declspec(dllexport) int FrameVariable_GetIntValue(nebula::Value* handle);
    __declspec(dllexport) bool FrameVariable_SetIntValue(nebula::Value* handle, int value);
    __declspec(dllexport) float FrameVariable_GetFloatValue(nebula::Value* handle);
    __declspec(dllexport) bool FrameVariable_SetFloatValue(nebula::Value* handle, float value);
    __declspec(dllexport) nebula::Bundle* FrameVariable_GetBundleValue(nebula::Value* handle);
    __declspec(dllexport) nebula::VariantArray* FrameVariable_GetArrayValue(nebula::Value* handle);
}
